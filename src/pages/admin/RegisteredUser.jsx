...
// //       console.log("stdres", stdres.data);
// //       // Combine the data
// //       const combinedData = {
// //         ...userResponse.data,
...
// //                   {/* Internships Section (if applicable) */}
...
// //                             {viewData.internships.length} Active
// //                           </span>
// //                         </div>
...
//       keywords: 'student, report, internship, achievements',
...
//       const [userResponse, profileResponse, stdres, achievementsResponse] = await Promise.all([
//         axios.get(`http://localhost:5000/api/users/${id}`),
//         axios.get(`http://localhost:5000/api/profiles/${id}`),
//         axios.get(`http://localhost:5000/api/profiles/student/${id}`),
...
//                             <h4 className="text-md font-semibold text-blue-800 mb-2">Remarks</h4>
//                             <p className="text-gray-700">
//                               {achievement.remarks || 'No remarks provided'}
//                             </p>
//                           </div>

//                           <h4 className="text-md font-semibold text-gray-800 mb-3">Evaluation Details</h4>
//                           <div className="overflow-x-auto">
//                             <Table striped bordered hover responsive>
//                               <thead>
//                                 <tr>
...
//                     <h3 className="text-lg font-semibold text-gray-700">No Achievements Recorded</h3>
